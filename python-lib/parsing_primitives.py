# From access_parser by Uri Katz https://github.com/claroty/access_parser/blob/master/access_parser/parsing_primitives.py

from construct import (
    Struct, Const, CString, Int32ul, Padding, Tell, BitStruct, Flag, Peek, IfThenElse,
    Int16ul, PaddedString, GreedyRange, Int8ul, Bytes, GreedyBytes, Prefixed, Computed,
    Switch, If, Array, Int8ub, Int16ub, this
)
